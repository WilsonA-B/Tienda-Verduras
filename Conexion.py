...
titulo = tk.Label(ventana, text="Bases de Datos", font=("Bookman Old Style", 16), bg="#e8f5e9", fg="#43a047")
...
boton1 = tk.Button(frame_botones, text="Clientes", bg="#43a047", fg="white", width=14, height=6)
boton2 = tk.Button(frame_botones, text="Botón 2", bg="#43a047", fg="white", width=14, height=6)
boton3 = tk.Button(frame_botones, text="Botón 3", bg="#43a047", fg="white", width=14, height=6)
boton4 = tk.Button(frame_botones, text="Botón 4", bg="#43a047", fg="white", width=14, height=6)
